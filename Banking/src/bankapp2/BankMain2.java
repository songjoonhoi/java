...
public class BankMain2 {
    ...
    public static void main(String[] args) {
        ...
        while (sw) {
            ...
            int selcetNum = Integer.parseInt(sc.nextLine());
    ...
    private static void deposit() {
        ...
        if (findAccount(ano) != null) { // 일치되는 계좌번호가 있으면
            ...
            // 예금 = 잔고 + 입금액
            account.setBalance(account.getBalance() + amount);
            System.out.println("결과: 정상 입금 되었습니다.\n 현재 잔액: " + account.getBalance());
    ...
    private static void createAccount() {
        ...
        while (true) {
            ...
            if (findAccount(ano) != null) { // 계좌가 이미 저장되어있다면
                System.out.println("이미 등록된 계좌입니다. 다시 입력하세요.");
            } else { // 계좌가 없다면
